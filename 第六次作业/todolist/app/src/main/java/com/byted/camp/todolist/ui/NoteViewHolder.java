    ...
    public void bind(final Note note) {
        ...
        checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                //Log.d("wecan:", note.getContent() + note.getState().toString());
        ...
        Log.d("wecan:", note.getPriority());
        if (note.getPriority().equals("Medium Priority"))
            item.setBackgroundColor(Color.rgb(200, 230, 236));
        else if (note.getPriority().equals("High Priority"))
            item.setBackgroundColor(Color.rgb(252, 222, 180));
    }
}
